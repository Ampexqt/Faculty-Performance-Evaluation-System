...
export function ProgramsPage() {
    ...
    const fetchPrograms = async () => {
        try {
            ...
            if (userInfo.collegeId) queryParams.append('college_id', userInfo.collegeId);
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/api/qce/programs', {
                ...
                body: JSON.stringify({
                    ...formData,
                    qceId: userId,
                    userType: 'dean', // Should be handled by backend to associate with college
                    collegeId: userInfo.collegeId // Verify if backend accepts this explicitly
                })
            });
        ...
        >
            <div className={styles.page}>
                <div className={styles.header}>
                    <div>
                        <h1 className={styles.title}>College Programs</h1>
                        <p className={styles.subtitle}>Manage programs and courses within your college.</p>
                    </div>
                    {/* Optionally allow Dean to add programs? Assuming yes */}
